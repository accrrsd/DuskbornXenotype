...
{
    public class TEST_EatVampire_CompClass : CompAbilityEffect
    {
        public new TEST_EatVampire_CompProperties Props => (TEST_EatVampire_CompProperties)props;
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            if (target.Pawn != null)
            {
                SanguophageUtility.DoBite(parent.pawn, target.Pawn, Props.hemogenGain, Props.nutritionGain, Props.targetBloodLoss, Props.resistanceGain, Props.bloodFilthToSpawnRange, Props.thoughtDefToGiveTarget, Props.opinionThoughtDefToGiveTarget);
        ...
        {
            bool validationPass = GetValidation(target, throwMessages);
            if (validationPass)
            {
        ...
        public bool GetValidation(LocalTargetInfo target, bool throwMessages = false)
        {
