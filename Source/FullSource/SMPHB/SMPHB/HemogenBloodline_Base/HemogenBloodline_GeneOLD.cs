...
{
    public class HemogenBloodline_GeneOLD : Gene_HemogenDrain
    {
        //Нужно как-то заставить не вызывать гизмо у гемогеника
        //МОЖНО попробовать перезаписывать стандартного гемогеника как это делают волосы
        //---------
        //План действий:
